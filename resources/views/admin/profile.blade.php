...
@section('content')
    @if(session('success'))
        <div class="alert alert-success" style="width: 70%; margin: 20px auto 0px;">
            {{ session('success') }}
        </div>
    @endif
            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.update-profile') }}" enctype="multipart/form-data">
                        ...
                        <img id="imagePreview" width="200" src="{{ isset($user->profile_pic) ? $user->profile_pic : asset('image/profile-pic.png') }}" height="200" style="text-align:max-width: 100%; height: auto; border: 1px solid #ddd; padding: 5px; margin-top: 10px; margin-bottom: 10px; border-radius: 5px;">
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <select name="role" id="selectRole" class="form-control @error('role') is-invalid @enderror" disabled>
                                        <option value="" selected disabled>Please select role</option>
                                        @foreach ($role_datas as $key => $role_data)
                                            <option value="{{ $role_data['name'] }}" {{ in_array($role_data['name'], $user->getRoleNames()->toArray()) ? 'selected' : '' }}>
                                                {{ $role_data['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input class="form-control" id="inputMiddleName" value="{{ $user->middle_name }}"name="middle_name" type="text" placeholder="Enter your middle name " />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input class="form-control @error('last_name') is-invalid @enderror" id="inputLastName" value="{{ $user->last_name }}" type="text" name="last_name" placeholder="Enter your last name" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control" id="inputSuffix" value="{{ $user->suffix }}" type="text" name="suffix" placeholder="Enter your suffix" />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input class="form-control @error('license_no') is-invalid @enderror" id="inputLicenseNo" value="{{ $user->license_no }}" type="text" name="license_no" placeholder="Enter your license number" />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input class="form-control  @error('email') is-invalid @enderror" id="inputEmail" type="email" value="{{ $user->email }}" name="email" placeholder="" />
