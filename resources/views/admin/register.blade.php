                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register.store') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input class="form-control @error('last_name') is-invalid @enderror" id="inputLastName" type="text" name="last_name" placeholder="Enter your last name" />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input class="form-control @error('license_no') is-invalid @enderror" id="inputLicenseNo" type="text" name="license_no" placeholder="Enter your license number" />
